...
from safetynet.safetynet import main
from safetynet.safetynet import process_adm_unit


@patch("safetynet.safetynet.get_unified_settings")
@patch("safetynet.safetynet.get_mo_client")
